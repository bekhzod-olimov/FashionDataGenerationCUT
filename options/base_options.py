...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='/home/miplab/Akhrorjon/CM_6/CUT_Project/datasets/GAN_train_dataset', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./model_files', help='models are saved here')
        # model parameters
